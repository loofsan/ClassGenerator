...
public class JsonCombiner {
    ...
    private static JSONObject combineJsonFiles(
            List<String> filePaths) throws IOException, JSONException
    {
    ...
    private static void writeJsonToFile(
            JSONObject jsonObject, String filePath) throws IOException
    {
        try (FileWriter fileWriter = new FileWriter(filePath))
        {
            // Indent with 4 spaces for better readability
